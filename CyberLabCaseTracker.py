...
class CaseLogApp:
    ...
    def create_about_widgets(self):
        ...
        about_text = (
            ...
            "XLSX Import Format:\n"
            "When importing cases from an Excel file, the following column headers are required:\n"
            "- ID: Unique identifier (optional, can be empty)\n"
            "- Case #: Case number or identifier\n"
            "- Examiner: Name of the examiner\n"
            "- Investigator: Name of the investigator\n"
            "- Agency: Agency or organization name\n"
            "- City: City where offense occurred\n"
            "- State: State where offense occurred\n"
            "- Start (MM-DD-YYYY): Case start date (format: MM-DD-YYYY)\n"
            "- End (MM-DD-YYYY): Case end date (format: MM-DD-YYYY)\n"
            "- Vol (GB): Volume size in gigabytes (numeric)\n"
            "- Offense: Type of offense or crime\n"
            "- Device: Type of device examined\n"
            "- Model: Device model\n"
            "- OS: Operating system\n"
            "- Recovered?: Data recovery status (Yes/No)\n"
            "- FPR?: Full Physical Recovery status (Yes/No)\n"
            "- Notes: Additional notes or comments\n"
            "- Created (YYYY-MM-DD): Creation date (format: YYYY-MM-DD)\n\n"
            "Note: All column headers must match exactly (case-sensitive). Missing columns will cause import to fail.\n\n"
            "Data Storage:\n"
