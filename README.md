...
- done✅ Future fix: When customizing columns in view data, your selection/deselection only goes into effect after closing and relaunching application. Fix: Have UI view auto refresh on applying.  
- done✅ Future fix: Settings UI shows default password as *password* actual default password is ***admin*** until user changes it.
- done✅ Future fix: Update About section to reflect current version number of application (v2.1.4)    
